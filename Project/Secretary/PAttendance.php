...
if(isset($_POST["btn_present"]))
{
    ...
    $insQry="insert into tbl_programattendance (member_id,program_id,programattendance_status) values ('".$mid."','".$_GET["prid"]."',1)";
	if($con->query($insQry))
		{
			// echo "Added";
		}
...
{
	$mid=$_POST["sel_members"];
    $insQry="insert into tbl_programattendance (member_id,program_id,programattendance_status) values ('".$mid."','".$_GET["prid"]."',2)";
	if($con->query($insQry))
		{
			// echo "Added";
		}
