...
<html lang="en">
    <head>
        ...
        <title>Kudumbashree.All</title>
        <link rel="shortcut icon" type="image/x-icon" href="assets/images/logo.png"/>

        <link href="Assets/Templates/Main/assets/css/bootstrap.min.css" rel="stylesheet">
        <link href="Assets/Templates/Main/assets/css/bootstrap-theme.min.css" rel="stylesheet">

        <link href="Assets/Templates/Main/assets/css/owl.carousel.css" rel="stylesheet">
        <link href="Assets/Templates/Main/assets/css/owl.theme.default.min.css" rel="stylesheet">

        <link href="Assets/Templates/Main/assets/css/magnific-popup.css" rel="stylesheet">

        <link href="Assets/Templates/Main/assets/css/style.css" rel="stylesheet">
    ...
    <body>
        <div id="menu-item" class="menu-item hide-menu">
            <div class="container">
                <ul>
                    ...
                    <a><li>.</li></a>
                    <a href="#purpose"><li>What we do</li></a>
                    <a><li>.</li></a>
            ...
            <header class="bg-img header">
                ...
                <div class="container">
                    <div class="row">
                        <div class="intro-box">
                            <div class="intro">
                                <h1>Kudumbashree.All</h1><br>
                                <p>"An Innovative Solution for Efficient Management of Kudumbashree Units."</p>
                                <a class="btn vira-btn" href="Guest/Login.php">Login</a>
                                <a class="btn vira-btn" href="Guest/Member.php">Sign Up</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <p>
                            "The Kudumbashree Unit Management System is a specialized platform designed to streamline the operations of individual Kudumbashree units.
                            This system automates tasks such as member management, meeting reporting, and program reporting, attendance tracking etc. 
                            It features a centralized database to store and manage data securely, a user-friendly interface for easy access and navigation by administrator, secretary, and members."
                            </p>
                            <!-- <img src="Assets/Templates/Main/assets/images/signature.png">
        ...
        <script src="Assets/Templates/Main/assets/js/jquery-3.1.1.js"></script>
        ...
        <script src="Assets/Templates/Main/assets/js/script.js"></script>
    </body>
</html>