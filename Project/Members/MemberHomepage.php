...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Welcome Back!, <?php echo $_SESSION["mname"]; ?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo $_SESSION["mname"]; ?></h6>
              <span>Member</span>
            </li>
            <li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="MemberProfile.php">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="MemberHomepage.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="ViewMAttendance.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="MViewProgram.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="ViewLoan.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="MyLoan.php">
  ...
  <main id="main" class="main">
    ...
    <h1 align="center">Welcome! <br><?php echo $_SESSION["mname"]; ?></h1>
