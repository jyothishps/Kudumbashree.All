...
if(isset($_POST["btn_login"]))
{
	...
	$selSecretary="select * from tbl_secretary where secretary_email='".$email."' and secretary_password='".$password."'";
	$resSecretary=$con->query($selSecretary);
	$selMember="select * from tbl_member where member_email='".$email."' AND member_password='".$password."'";
	...
	else if($data=$resSecretary->fetch_assoc())
	{
		$_SESSION["sid"]=$data["secretary_id"];
		$_SESSION["sname"]=$data["secretary_name"];
		header("location:../Secretary/SecretaryHomepage.php");	
	}
	else if($data=$resMember->fetch_assoc())
	{
		if($data["member_status"]==1)
		{
		$_SESSION["mid"]=$data["member_id"];
		$_SESSION["mname"]=$data["member_name"];
		header("location:../Members/MemberHomepage.php");
		}
		else if($data["member_status"]==0)
		{
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="post">
                    ...
                    <div class="col-12">
                      <input class="btn btn-primary w-100" type="submit" value="Login" name="btn_login">
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="Member.php">Create an account</a></p>
                    </div>
                  </form>
